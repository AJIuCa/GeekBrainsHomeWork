...
public class StartWorkWithDatabase {
...
//        getUserFromDatabase();
    ...
    public static void getUserFromDatabaseByNick() throws SQLException {

        UsersDatabase user1 = new UsersDatabase();
        System.out.println(user1.getUserByNick("Atos"));
    }

    public static void getUserFromDatabaseByLogin() throws SQLException {
